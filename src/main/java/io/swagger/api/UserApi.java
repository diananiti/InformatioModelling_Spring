...
public interface UserApi {
    ...
    @ApiOperation(value = "Create user", nickname = "createUser", notes = "This can only be done by the logged in user.",authorizations= {
            @Authorization(value = "persistdata_auth", scopes = {
                    @AuthorizationScope(scope = "read:users", description = "read your userss records"),
    ...
    @ApiOperation(value = "Delete user", nickname = "deleteUser", notes = "This can only be done by the logged in user.", tags={ "user", },authorizations= {
            @Authorization(value = "persistdata_auth", scopes = {
                    @AuthorizationScope(scope = "read:users", description = "read your userss records"),
                    @AuthorizationScope(scope = "write:users", description = "modify users records in your account")
            })
    ...
    ResponseEntity<User> deleteUser(@ApiParam(value = "The id that needs to be deleted",required=true) @PathVariable("id") long id);


    @ApiOperation(value = "find all users", nickname = "findAllStudents", notes = "", response = User.class, responseContainer = "List", authorizations = {
            @Authorization(value = "persistdata_auth", scopes = {
    ...
    @ApiOperation(value = "Logs user into the system", nickname = "loginUser", notes = "", tags={ "user", },authorizations= {
            @Authorization(value = "persistdata_auth", scopes = {
                    @AuthorizationScope(scope = "read:users", description = "read your userss records"),
                    @AuthorizationScope(scope = "write:users", description = "modify users records in your account")
            })
    ...
    @RequestMapping(value = "/user/login",
        produces = { "application/xml", "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Void> loginUser(@NotNull @ApiParam(value = "The user name for login", required = true) @Valid @RequestParam(value = "username", required = true) String username,@NotNull @ApiParam(value = "The password for login in clear text", required = true) @Valid @RequestParam(value = "password", required = true) String password);


    @ApiOperation(value = "Logs out current logged in user session", nickname = "logoutUser", notes = "", tags={ "user", },authorizations= {
            @Authorization(value = "persistdata_auth", scopes = {
                    @AuthorizationScope(scope = "read:users", description = "read your userss records"),
                    @AuthorizationScope(scope = "write:users", description = "modify users records in your account")
            })
    ...
    @ApiOperation(value = "Updated user", nickname = "updateUser", notes = "This can only be done by the logged in user.", tags={ "user", },authorizations= {
            @Authorization(value = "persistdata_auth", scopes = {
                    @AuthorizationScope(scope = "read:users", description = "read your userss records"),
                    @AuthorizationScope(scope = "write:users", description = "modify users records in your account")
            })
