...
@Controller
public class PurchasePlatformApiController implements PurchasePlatformApi {

    private static final Logger log = LoggerFactory.getLogger(PurchasePlatformApiController.class);
    ...
    public PurchasePlatformApiController(ObjectMapper objectMapper, HttpServletRequest request) {
